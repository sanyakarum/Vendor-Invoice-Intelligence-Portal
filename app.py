...
This internal analytics portal leverages achine learning to
- **Forecast freight costs accurately**
- **Delete risky or abnormal vendor invoices**
...
#Invoice Flag Prediction
    ...
    st.subheader("🚨Invoice Mannual Approval Prediction")

    st.markdown("""
    **Objective:**
    Predict whether a vendor invoice should be **flagged or manual approval**
    ...
    if submit_flag:
            ...
            if is_flagged:
                ...
                st.success("✅Invoice is **SAFE for auto-apporoval**")
